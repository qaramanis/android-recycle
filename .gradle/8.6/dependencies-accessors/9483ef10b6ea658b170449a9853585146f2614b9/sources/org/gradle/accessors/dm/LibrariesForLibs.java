...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    public static class ActivityLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {
        ...
        /**
         * Dependency provider for <b>v160alpha05</b> with <b>androidx.activity:activity</b> coordinates and
         * with version reference <b>activityVersion</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getV160alpha05() {
            return create("activity.v160alpha05");
        }
    ...
    public static class AndroidxAppcompatLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Dependency provider for <b>v100</b> with <b>androidx.appcompat:appcompat</b> coordinates and
         * with version reference <b>appcompatVersion</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getV100() {
            return create("androidx.appcompat.v100");
        }

    }

    public static class AndroidxMaterial3LibraryAccessors extends SubDependencyFactory {
        private final AndroidxMaterial3AdaptiveLibraryAccessors laccForAndroidxMaterial3AdaptiveLibraryAccessors = new AndroidxMaterial3AdaptiveLibraryAccessors(owner);

        public AndroidxMaterial3LibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>androidx.material3.adaptive</b>
         */
        public AndroidxMaterial3AdaptiveLibraryAccessors getAdaptive() {
            return laccForAndroidxMaterial3AdaptiveLibraryAccessors;
        }

    }

    public static class AndroidxMaterial3AdaptiveLibraryAccessors extends SubDependencyFactory {
        private final AndroidxMaterial3AdaptiveNavigationLibraryAccessors laccForAndroidxMaterial3AdaptiveNavigationLibraryAccessors = new AndroidxMaterial3AdaptiveNavigationLibraryAccessors(owner);

        public AndroidxMaterial3AdaptiveLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>androidx.material3.adaptive.navigation</b>
         */
        public AndroidxMaterial3AdaptiveNavigationLibraryAccessors getNavigation() {
            return laccForAndroidxMaterial3AdaptiveNavigationLibraryAccessors;
        }

    }

    public static class AndroidxMaterial3AdaptiveNavigationLibraryAccessors extends SubDependencyFactory {

        public AndroidxMaterial3AdaptiveNavigationLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
         ...
         * with version reference <b>material3AdaptiveNavigationSuite</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getSuite() {
            return create("androidx.material3.adaptive.navigation.suite");
        }
    ...
    public static class MaterialLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {
        ...
        /**
         * Dependency provider for <b>v130alpha03</b> with <b>com.google.android.material:material</b> coordinates and
         * with version reference <b>materialVersion</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getV130alpha03() {
            return create("material.v130alpha03");
        }
        ...
        /**
         * Dependency provider for <b>v160</b> with <b>com.google.android.material:material</b> coordinates and
         * with version reference <b>googleMaterialVersion</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getV160() {
            return create("material.v160");
        }
    ...
    public static class PlayServicesMapsLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {
        ...
        /**
         * Dependency provider for <b>v1700</b> with <b>com.google.android.gms:play-services-maps</b> coordinates and
         * with version reference <b>playServicesMapsVersion</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getV1700() {
            return create("play.services.maps.v1700");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>activityVersion</b> with value <b>1.6.0-alpha05</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getActivityVersion() { return getVersion("activityVersion"); }
        ...
        /**
         * Version alias <b>appcompatVersion</b> with value <b>1.0.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>googleMaterialVersion</b> with value <b>1.6.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getGoogleMaterialVersion() { return getVersion("googleMaterialVersion"); }
        ...
        /**
         * Version alias <b>material3AdaptiveNavigationSuite</b> with value <b>1.3.0-beta02</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getMaterial3AdaptiveNavigationSuite() { return getVersion("material3AdaptiveNavigationSuite"); }

        /**
         * Version alias <b>materialVersion</b> with value <b>1.3.0-alpha03</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>playServicesMapsVersion</b> with value <b>17.0.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
